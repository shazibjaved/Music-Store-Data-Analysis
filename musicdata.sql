...
/*Q1: Who is the most senior employe based on the job title?*/
...
from track
where milliseconds >(
select avg(milliseconds) as total_avg_length
from track
)
...
JOIN album2 al2 ON al2.album_id = t.album_id
JOIN best_selling_artist bsa ON bsa.artist_id = al2.artist_id
